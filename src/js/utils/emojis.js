export const emojis = {
  ...
  '[酷]':
    "<img class='emoji' alt='[酷]' title='酷' src='https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/16.gif'>",
  '[冷汗]':
  ...
  '[衰]':
    "<img class='emoji' alt='[衰]' title='衰' src='https://res.wx.qq.com/mpres/htmledition/images/icon/emotion/36.gif'>",
  '[骷髅]':
